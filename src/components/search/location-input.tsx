      ...
      <div className="flex flex-col gap-1.5 flex-1 min-w-0">
        ...
        <button type="button" onClick={()=>setOpen(true)}
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            {airportProp
              ? <span className="flex items-center gap-2 min-w-0"><span className="font-semibold text-foreground text-base truncate">{airportProp.city}</span><span className="text-muted-foreground text-sm font-mono shrink-0">{airportProp.iata}</span></span>
